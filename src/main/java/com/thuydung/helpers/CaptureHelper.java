...
public class CaptureHelper extends ScreenRecorder {
    ...
    public static void startRecord(String methodName) {
        ...
        File file = new File(PropertiesHelper.getValue("VIDEO_RECORD_PATH"));
        if (!file.exists()) {
            file.mkdirs();
        }
    ...
    public static void takeScreenshot(ITestResult result) {
        ...
        try {
            FileHandler.copy(source, new File(PropertiesHelper.getValue("SCREENSHOT_PATH") + result.getName() + ".png"));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    ...
    public static void takeScreenshot(String name) {
        ...
        try {
            ...
            FileHandler.copy(source, new File(PropertiesHelper.getValue("SCREENSHOT_PATH") + name + ".png"));
