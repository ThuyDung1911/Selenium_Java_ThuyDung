...
public class ProfilePage extends CommonPage{
    ...
    public static By selectAvatar = By.xpath("//div[@class='form-control file-amount']");
    ...
    public static By messageNotPermitted = By.xpath("//span[@data-notify='message' and normalize-space() = 'Sorry! the action is not permitted in demo']");
    ...
    public static By buttonVerifyEmail = By.xpath("//button[@class='btn btn-outline-secondary new-email-verification']");
    ...
    public static By titleAddress = By.xpath("//h5[normalize-space()='Address']");
    ...
    public static By inputYourAddress = By.xpath("(//textarea[@name='address'])[2]");
    public static By inputAddYourAddress = By.xpath("(//textarea[@name='address'])[1]");
    ...
    public static By selectState = By.xpath("(//select[@name='state_id']/parent::div)[2]");
    public static By selectAddState = By.xpath("(//select[@name='state_id']/parent::div)[1]");
    public static By inputSearchState = By.xpath("//div[@class='dropdown-menu show']//input[@aria-label='Search']");
    public static By selectCity = By.xpath("(//select[@name='city_id']/parent::div)[2]");
    public static By selectAddCity = By.xpath("(//select[@name='city_id']/parent::div)[1]");
    public static By inputSearchCity = By.xpath("//div[@class='dropdown-menu show']//input[@aria-label='Search']");
    public static By inputPostalCode = By.xpath("(//input[@name='postal_code'])[2]");
    public static By inputAddPostalCode = By.xpath("(//input[@name='postal_code'])[1]");
    public static By inputPhoneAddress = By.xpath("(//input[@name='phone'])[3]");
    public static By inputAddPhoneAddress = By.xpath("(//input[@name='phone'])[2]");
    public static By buttonSaveNewAddress = By.xpath("(//button[normalize-space()='Save'])[1]");
    public static By buttonSaveEditAddress = By.xpath("(//button[normalize-space()='Save'])[2]");
