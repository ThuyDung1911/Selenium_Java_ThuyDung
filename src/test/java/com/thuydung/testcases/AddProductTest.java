...
public class AddProductTest extends BaseTest {
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 3, description = "Kiem tra them san pham moi khong hop le voi role admin")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 4, description = "Kiem tra them san pham moi co variant, co discount hop le voi role admin")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 5, description = "Kiem tra them san pham moi co variant, co discount khong hop le voi role admin")
