...
public class AddProductTest extends BaseTest {
    ...
    public void testAddProductVariantValid(Hashtable<String, String> data) {
        ...
        excelAddProduct.setExcelFile("DataTest/AddProduct.xlsx", "AddProduct");
        getLoginPage().loginSuccessAdminPage(excelLogin.getCellData("email", 5), excelLogin.getCellData("password", 5));
        getAddProductPage().addProductVariantValid(data.get("productName"), data.get("category"), data.get("unit"), data.get("weight"), data.get("tags"), data.get("unitPrice"), data.get("discountDate"), data.get("quantity"), data.get("description"), data.get("discount"), data.get("image"), data.get("vat"));
    }
