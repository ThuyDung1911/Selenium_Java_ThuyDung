...
public class OrderTest extends BaseTest {
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 3, description = "Kiểm tra chức năng tạo đơn hàng thành công khi có không áp mã giảm giá")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 6, description = "Kiểm tra truy cập trang shipping info khi chưa đăng nhập")
    public void TC_OpenShippingInfoWithoutLogin() {
        getOrderPage().testOpenShippingInfoWithoutLogin();
    }

    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 7, description = "Kiểm tra chức năng thêm địa chỉ giao hàng hợp lệ")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 8, description = "Kiểm tra chức năng thêm địa chỉ giao hàng không hợp lệ")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 9, description = "Kiểm tra chức năng sửa địa chỉ giao hàng hợp lệ")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 10, description = "Kiểm tra chức năng sửa địa chỉ giao hàng không hợp lệ")
...
//    }
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 12, description = "Kiểm tra truy cập trang delivery info từ trang shipping info khi có địa chỉ")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 13, description = "Kiểm tra khi chọn phương thức vận chuyển")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 14, description = "Kiểm tra truy cập trang Payment từ trang Shipping Info")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 15, description = "Kiểm tra khi chọn phương thức thanh toán Cash on Delivery")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 16, description = "Kiểm tra khi chưa đồng ý điều kiện, điều khoản")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 17, description = "Kiểm tra chức năng hủy đơn hàng")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 18, description = "Kiểm tra áp mã coupon hợp lệ")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 19, description = "Kiểm tra áp mã coupon không tồn tại")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 20, description = "Kiểm tra áp mã coupon đã hết hạn")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 21, description = "Kiểm tra khi ấn vào link Terms and Conditions")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 22, description = "Kiểm tra khi ấn vào link Privacy Policy")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 23, description = "Kiểm tra truy cập trang Confirm order từ URL")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 24, description = "Kiểm tra truy cập trang Payment từ URL")
    ...
    @JiraCreateIssue(isCreateIssue = false)
    @Test(priority = 25, description = "Kiểm tra truy cập trang delivery info từ URL")
