...
public class RegisterTest extends BaseTest {
    ...
    public void TC_RegisterFailCustomerWithoutFullname() {
        ExcelHelper excel = new ExcelHelper();
        excel.setExcelFile("DataTest/Register.xlsx", "Register");
        getRegisterPage().registerFailWithoutFullname(excel.getCellData("email", 2), excel.getCellData("password", 2), excel.getCellData("confirm password", 2));
    }
    ...
    public void TC_RegisterFailCustomerWithoutEmail() {
        ExcelHelper excel = new ExcelHelper();
        excel.setExcelFile("DataTest/Register.xlsx", "Register");
        getRegisterPage().registerFailWithoutEmail(excel.getCellData("fullname", 3), excel.getCellData("password", 3), excel.getCellData("confirm password", 3));
    }
...
//        ExcelHelper excel = new ExcelHelper();
//        excel.setExcelFile("DataTest/Register.xlsx", "Register");
//        getRegisterPage().registerFailWithoutPassword(excel.getCellData("fullname", 6), excel.getCellData("email", 6), excel.getCellData("confirm password", 6));
//    }
